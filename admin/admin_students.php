...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_student'])) {
    ...
    $reg_number = $conn_students->real_escape_string($_POST['reg_number']);
    $department = $conn_students->real_escape_string($_POST['department']);
    $academic_year = $conn_students->real_escape_string($_POST['academic_year']);
    $section = $conn_students->real_escape_string($_POST['section']);
    $dob = $conn_students->real_escape_string($_POST['dob']);
    $gender = $conn_students->real_escape_string($_POST['gender']);
    $mobile = $conn_students->real_escape_string($_POST['mobile']);
    $hostel_day = $conn_students->real_escape_string($_POST['hostel_day']);
    $address = $conn_students->real_escape_string($_POST['address']);
    $email = $conn_students->real_escape_string($_POST['email']);
    
    $sql = "UPDATE students SET name=?, reg_number=?, department=?, academic_year=?, section=?, dob=?, gender=?, mobile=?, hostel_day=?, address=?, email=? WHERE id = ?";
    $stmt = $conn_students->prepare($sql);
    $stmt->bind_param("sssssssssssi", $name, $reg_number, $department, $academic_year, $section, $dob, $gender, $mobile, $hostel_day, $address, $email, $student_id);
                            ...
                            <form id="addStudentForm" method="POST" action="add_student.php" class="space-y-4">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" id="name" name="name" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="regno">Register Number</label>
                                        <input type="text" id="regno" name="regno" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="department">Department</label>
                                        <select id="department" name="department" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    ...
                                    <div>
                                        ...
                                        <select id="academic_year" name="academic_year" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="section" name="section" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="dob">Date of Birth</label>
                                        <input type="date" id="dob" name="dob" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="gender">Gender</label>
                                        <select id="gender" name="gender" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="mobile" name="mobile" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="hostel_day">Hosteller/Day Scholar</label>
                                        <select id="hostel_day" name="hostel_day" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="password">Password</label>
                                        <input type="password" id="password" name="password" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                    <div>
                                        <label class="block text-gray-700 dark:text-gray-300 mb-2" for="confirm_password">Confirm Password</label>
                                        <input type="password" id="confirm_password" name="confirm_password" required class="w-full px-3 py-2 border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                                    </div>
                                </div>
                                <div class="space-y-4">
